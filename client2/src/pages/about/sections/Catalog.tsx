    ...
    return (
        <div className="mx-auto w-fit flex ">
            ...
            <div className="gradientBack w-[134px] about_image_3 rounded-[0_10px_10px_10px] xl:rounded-[0_30px_30px_30px] relative ">
                ...
                <motion.button variants={textVariant(.75)} className="p2 bg-[#009894] shadow-2xl font-bold px-[1vw] py-[.5vw] rounded-[5px] xl:rounded-[10px] btnShadow absolute bottom-[3vw] right-[3vw]">View all</motion.button>
