    ...
    return (
        <div className="w-full text-lightText mt-5 mx-auto">
            ...
            {error ?
                ...
                <div className="rounded-[10px] border-solid border-[1px] p-[50px] md:p-[50px] border-[#02fe4f] bg-bgCardHover cursor-pointer min-h-[400px] flex flex-col items-center justify-center">
                    <p className="font-grotesk text-[36px] text-center">Sorry, some error occured. Make a new order again.</p>
                    <button
                ...
                : cart.length >= 1 ?
                    ...
                    : <div className="rounded-[10px] border-solid border-[1px] p-[50px] md:p-[50px] border-[#02fe4f] bg-bgCardHover cursor-pointer min-h-[400px] flex items-center justify-center">
                        <p className="font-grotesk text-[36px] text-center">Your cart is empty.</p>
                    </div>
            }
        </div>
    )
