...
const Hero = () => {
    ...
    return <div className="w-full">
        ...
        <div className='w-full flex items-center flex-col'>
            <Image src="./skull_logo_hero.svg" width={168} height={168} alt="skull_logo" className="logo lg:w-[168px] lg-h-[168px]" />
            ...
            <button className='bg-primary px-[37px] py-[6px] rounded-[45px] mt-[17px]'>SHOP NOW</button>
        </div>
        <motion.div>
