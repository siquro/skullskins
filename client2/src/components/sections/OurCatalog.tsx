...
const OurCatalog = () => {
    ...
    return (
        <motion.div variants={fadeIn('right', 'linear', .2, 1)} className={`w-fit flex flex-col md:flex-row relative rounded-[10px] p-[15px] md:p-[2em] mt-[70px] bg-[#1c1c1c80] justify-center mx-[auto]`}>
            <div className="">
                <Image src="/about/headphones.png" width={506} height={561} alt="player" className="" priority />
            </div>
            <div className="flex flex-col justify-center rounded-[10px] border-solid border-2 border-[#02fe4f] bg-bgGreenOneCornerShade p-[15px] md:p-[2em] h-[auto] w-[100%] md:w-[60%]">
...
export default SectionWrapper(OurCatalog, '', "", "", "")